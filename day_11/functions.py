...
print('Full Name: ', generate_full_name('Erendira','Hernandez'))
...
def print_name(firstname):
    return firstname
print(print_name('Erwin')) # Erwin

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print(print_full_name('Erwin', 'Frias'))
...
def generate_full_name (first_name = 'Oscar', last_name = 'Frias'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name

print(generate_full_name())
print(generate_full_name('Erendira','Hernandez'))
